...
1. Agregar el siguiente código al final del archivo **C:\Windows\System32\drivers\etc\hosts**
	>
		# Host virtual para el proyecto CV Petrix en Laravel (Lado del cliente) 
...
1. Agregar el siguiente código al final del archivo **C:\xampp\apache\conf\extra\httpd-vhosts.conf**
	>
		# Host virtual para el proyecto CV Petrix en Laravel (Lado del servidor)
		<VirtualHost *:80>
...
1. Modificar la vista **welcome** en 
...
1. Crear base de datos Postgre SQL desde la terminal:
	...
	#### Nota: la salida de la última línea de comando nos servira para configurar las variables de entorno de la base de datos:
	>
...
git remote set-url Origin https://github.com/petrix12/cvpetrix.git
git remote set-url https://github.com/petrix12/cvpetrix.git
git remote set-url --delete git.heroku.com/cvpetrix.git
git remote set-url push https://github.com/petrix12/cvpetrix.git
git remote set-url Origin https://github.com/petrix12/cvpetrix.git
git remote add heroku git.heroku.com/cvpetrix.git
git remote delete heroku git.heroku.com/cvpetrix.git
git remote set-url --delete <name> <url>
git remote set-url --delete heroku https://git.heroku.com/cvpetrix.git
