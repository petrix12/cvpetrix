...
1. Salir de Heroku:
	+ $ heroku logout
1. Desconectar repositorio Heroku:
	+ $ git remote rm heroku
1. Volver a conectar con GitHub:
	+ $ git branch -M main
	+ $ git remote add origin https://github.com/petrix12/cvpetrix.git
	+ $ git push -u origin main
...
Heroku: https://git.heroku.com/cvpetrix.git
GitHub: https://github.com/petrix12/cvpetrix.git

git submodule add https://github.com/petrix12/cvpetrix.git
git submodule init
